...
function resolveTo(toArg, routePathnames, locationPathname, isPathRelative) {
  ...
  let to = typeof toArg === "string" ? parsePath(toArg) : _extends$8({}, toArg);
...
const Link$1 = /*#__PURE__*/React__namespace.forwardRef(function LinkWithRef(_ref4, ref) {
  let {
    ...
    preventScrollReset
      ...
      rest = _objectWithoutPropertiesLoose$6(_ref4, _excluded);
  ...
  return (
    ...
    React__namespace.createElement("a", _extends$6({}, rest, {
      href: href,
...
const NavLink = /*#__PURE__*/React__namespace.forwardRef(function NavLinkWithRef(_ref5, ref) {
  let {
    ...
    children
      ...
      rest = _objectWithoutPropertiesLoose$6(_ref5, _excluded2);
  ...
  return /*#__PURE__*/React__namespace.createElement(Link$1, _extends$6({}, rest, {
...
const Form = /*#__PURE__*/React__namespace.forwardRef((props, ref) => {
  return /*#__PURE__*/React__namespace.createElement(FormImpl, _extends$6({}, props, {
    ref: ref
  }));
});
...
const FormImpl = /*#__PURE__*/React__namespace.forwardRef((_ref6, forwardedRef) => {
  let {
    ...
    relative
      ...
      props = _objectWithoutPropertiesLoose$6(_ref6, _excluded3);
  ...
  return /*#__PURE__*/React__namespace.createElement("form", _extends$6({
    ref: forwardedRef,
    method: formMethod,
    action: formAction,
...
var de=(n=>(n[n.SetSelectedIndex=0]="SetSelectedIndex",n[n.RegisterTab=1]="RegisterTab",n[n.UnregisterTab=2]="UnregisterTab",n[n.RegisterPanel=3]="RegisterPanel",n[n.UnregisterPanel=4]="UnregisterPanel",n))(de||{});let pe={[0](e,t){let r=e.tabs.filter(i=>{var l;return !((l=i.current)!=null&&l.hasAttribute("disabled"))});if(t.index<0)return {...e,selectedIndex:e.tabs.indexOf(r[0])};if(t.index>e.tabs.length)return {...e,selectedIndex:e.tabs.indexOf(r[r.length-1])};let o=e.tabs.slice(0,t.index),n=[...e.tabs.slice(t.index),...o].find(i=>r.includes(i));return n?{...e,selectedIndex:e.tabs.indexOf(n)}:e},[1](e,t){var n;if(e.tabs.includes(t.tab))return e;let r=e.tabs[e.selectedIndex],o=S$2([...e.tabs,t.tab],i=>i.current),s=(n=o.indexOf(r))!=null?n:e.selectedIndex;return s===-1&&(s=e.selectedIndex),{...e,tabs:o,selectedIndex:s}},[2](e,t){return {...e,tabs:e.tabs.filter(r=>r!==t.tab)}},[3](e,t){return e.panels.includes(t.panel)?e:{...e,panels:S$2([...e.panels,t.panel],r=>r.current)}},[4](e,t){return {...e,panels:e.panels.filter(r=>r!==t.panel)}}},z=React.createContext(null);z.displayName="TabsSSRContext";function V(e){let t=React.useContext(z);if(t===null){let r=new Error(`<${e} /> is missing a parent <Tab.Group /> component.`);throw Error.captureStackTrace&&Error.captureStackTrace(r,V),r}return t}let q$1=React.createContext(null);q$1.displayName="TabsDataContext";function D(e){let t=React.useContext(q$1);if(t===null){let r=new Error(`<${e} /> is missing a parent <Tab.Group /> component.`);throw Error.captureStackTrace&&Error.captureStackTrace(r,D),r}return t}let J=React.createContext(null);J.displayName="TabsActionsContext";function Q(e){let t=React.useContext(J);if(t===null){let r=new Error(`<${e} /> is missing a parent <Tab.Group /> component.`);throw Error.captureStackTrace&&Error.captureStackTrace(r,Q),r}return t}function fe(e,t){return u$4(t.type,pe,e,t)}let be$1=React.Fragment,Te=C$2(function(t,r){let{defaultIndex:o=0,vertical:s=!1,manual:n=!1,onChange:i,selectedIndex:l=null,...y$1}=t;const p$1=s?"vertical":"horizontal",S=n?"manual":"auto";let b=l!==null,u=y(r),[c,f]=React.useReducer(fe,{selectedIndex:l!=null?l:o,tabs:[],panels:[]}),T=React.useMemo(()=>({selectedIndex:c.selectedIndex}),[c.selectedIndex]),x=s$7(i||(()=>{})),R=s$7(c.tabs),E=React.useMemo(()=>({orientation:p$1,activation:S,...c}),[p$1,S,c]),A=s$7(b?t.selectedIndex:c.selectedIndex),L=React.useMemo(()=>({registerTab(d){return f({type:1,tab:d}),()=>f({type:2,tab:d})},registerPanel(d){return f({type:3,panel:d}),()=>f({type:4,panel:d})},change(d){A.current!==d&&x.current(d),b||f({type:0,index:d});}}),[f,b]);s$8(()=>{f({type:0,index:l!=null?l:o});},[l]);let k=React.useRef({tabs:[],panels:[]}),G={ref:u};return React__default["default"].createElement(z.Provider,{value:k},React__default["default"].createElement(J.Provider,{value:L},React__default["default"].createElement(q$1.Provider,{value:E},E.tabs.length<=0&&React__default["default"].createElement(p,{onFocus:()=>{var d,U;for(let M of R.current)if(((d=M.current)==null?void 0:d.tabIndex)===0)return (U=M.current)==null||U.focus(),!0;return !1}}),$$2({ourProps:G,theirProps:y$1,slot:T,defaultTag:be$1,name:"Tabs"}))))}),me="div",Pe$1=C$2(function(t,r){let{orientation:o,selectedIndex:s}=D("Tab.List"),n=y(r);return $$2({ourProps:{ref:n,role:"tablist","aria-orientation":o},theirProps:t,slot:{selectedIndex:s},defaultTag:me,name:"Tabs.List"})}),xe$1="button",ge$1=C$2(function(t$1,r){var M,X;let o=`headlessui-tabs-tab-${I$2()}`,{orientation:s,activation:n,selectedIndex:i,tabs:l,panels:y$1}=D("Tab"),p=Q("Tab"),S=D("Tab"),b=V("Tab"),u=React.useRef(null),c=y(u,r);s$8(()=>p.registerTab(u),[p,u]);let f=b.current.tabs.indexOf(o);f===-1&&(f=b.current.tabs.push(o)-1);let T=l.indexOf(u);T===-1&&(T=f);let x=T===i,R=o$3(a=>{var j;let g=a();if(g===M$5.Success&&n==="auto"){let W=(j=e$2(u))==null?void 0:j.activeElement,Y=S.tabs.findIndex(ne=>ne.current===W);Y!==-1&&p.change(Y);}return g}),E=o$3(a=>{let g=l.map(W=>W.current).filter(Boolean);if(a.key===o$1.Space||a.key===o$1.Enter){a.preventDefault(),a.stopPropagation(),p.change(T);return}switch(a.key){case o$1.Home:case o$1.PageUp:return a.preventDefault(),a.stopPropagation(),R(()=>O(g,T$3.First));case o$1.End:case o$1.PageDown:return a.preventDefault(),a.stopPropagation(),R(()=>O(g,T$3.Last))}if(R(()=>u$4(s,{vertical(){return a.key===o$1.ArrowUp?O(g,T$3.Previous|T$3.WrapAround):a.key===o$1.ArrowDown?O(g,T$3.Next|T$3.WrapAround):M$5.Error},horizontal(){return a.key===o$1.ArrowLeft?O(g,T$3.Previous|T$3.WrapAround):a.key===o$1.ArrowRight?O(g,T$3.Next|T$3.WrapAround):M$5.Error}}))===M$5.Success)return a.preventDefault()}),A=React.useRef(!1),L=o$3(()=>{var a;A.current||(A.current=!0,(a=u.current)==null||a.focus(),p.change(T),t(()=>{A.current=!1;}));}),k=o$3(a=>{a.preventDefault();}),G=React.useMemo(()=>({selected:x}),[x]),d=t$1,U={ref:c,onKeyDown:E,onMouseDown:k,onClick:L,id:o,role:"tab",type:s$6(t$1,u),"aria-controls":(X=(M=y$1[T])==null?void 0:M.current)==null?void 0:X.id,"aria-selected":x,tabIndex:x?0:-1};return $$2({ourProps:U,theirProps:d,slot:G,defaultTag:xe$1,name:"Tabs.Tab"})}),ye="div",Re=C$2(function(t,r){let{selectedIndex:o}=D("Tab.Panels"),s=y(r),n=React.useMemo(()=>({selectedIndex:o}),[o]);return $$2({ourProps:{ref:s},theirProps:t,slot:n,defaultTag:ye,name:"Tabs.Panels"})}),Ae="div",Ee$1=S$1.RenderStrategy|S$1.Static,Se$1=C$2(function(t,r){var R,E,A,L;let{selectedIndex:o,tabs:s,panels:n}=D("Tab.Panel"),i=Q("Tab.Panel"),l=V("Tab.Panel"),y$1=`headlessui-tabs-panel-${I$2()}`,p=React.useRef(null),S=y(p,r);s$8(()=>i.registerPanel(p),[i,p]);let b=l.current.panels.indexOf(y$1);b===-1&&(b=l.current.panels.push(y$1)-1);let u=n.indexOf(p);u===-1&&(u=b);let c=u===o,f=React.useMemo(()=>({selected:c}),[c]),T=t,x={ref:S,id:y$1,role:"tabpanel","aria-labelledby":(E=(R=s[u])==null?void 0:R.current)==null?void 0:E.id,tabIndex:c?0:-1};return !c&&((A=t.unmount)!=null?A:!0)&&!((L=t.static)!=null&&L)?React__default["default"].createElement(h$3,{as:"span",...x}):$$2({ourProps:x,theirProps:T,slot:f,defaultTag:Ae,features:Ee$1,visible:c,name:"Tabs.Panel"})}),qe=Object.assign(ge$1,{Group:Te,List:Pe$1,Panels:Re,Panel:Se$1});
...
var Button = function (_a) {
    ...
    var children = _a.children, disabled = _a.disabled, primary = _a.primary, secondary = _a.secondary, simple = _a.simple, darkFont = _a.darkFont, overrideColor = _a.overrideColor, editor = _a.editor, outline = _a.outline, onClick = _a.onClick, type = _a.type;
    return (jsxRuntime.jsx("button", __assign({ type: type ? type : "button", onClick: onClick, disabled: disabled, style: simple
            ? { color: overrideColor }
            : outline
                ? { color: overrideColor, border: "2px solid " + overrideColor }
                : primary
                    ? { backgroundColor: overrideColor }
                    : {}, className: classNames$1(styles$5.button, (_b = {}, _b[styles$5.primary] = primary, _b), (_c = {}, _c[styles$5.editor] = editor, _c), (_d = {}, _d[styles$5.secondary] = secondary, _d), (_e = {}, _e[styles$5.outline] = outline, _e), (_f = {}, _f[styles$5.darkFont] = darkFont, _f), (_g = {}, _g[styles$5.simple] = simple, _g)) }, { children: children })));
};

function ConfirmationBox(_a) {
    var onCancel = _a.onCancel, onConfirm = _a.onConfirm, popButton = _a.popButton, panelText = _a.panelText;
    return (jsxRuntime.jsxs(mt, { children: [jsxRuntime.jsx(mt.Button, __assign({ "data-testid": "popbutton" }, { children: popButton })), jsxRuntime.jsx(We, __assign({ as: React.Fragment, enter: "transition ease-out duration-200", enterFrom: "opacity-0 translate-y-1", enterTo: "opacity-100 translate-y-0", leave: "transition ease-in duration-150", leaveFrom: "opacity-100 translate-y-0", leaveTo: "opacity-0 translate-y-1" }, { children: jsxRuntime.jsx(mt.Panel, __assign({ "data-testid": "panel", className: "absolute z-1000 px-4 mt-3  transform -translate-x-96 -translate-y-24 sm:px-0 lg:max-w-3xl" }, { children: jsxRuntime.jsxs("div", __assign({ className: "w-80 shadow-lg rounded-md border-solid border-2" }, { children: [jsxRuntime.jsxs("div", __assign({ className: "flex items-center justify-start relative gap-2 bg-white p-5 " }, { children: [jsxRuntime.jsx(AlertTriangle$1, { size: 24, color: "var(--color-errorMedium)" }), jsxRuntime.jsx("div", __assign({ "data-testid": "div", className: "text-gray-800" }, { children: panelText }))] })), jsxRuntime.jsxs("div", __assign({ className: "flex justify-end space-x-2 bg-light-gray p-2 bg-error-red" }, { children: [jsxRuntime.jsx(Button, __assign({ simple: true, overrideColor: "var(--color-mediumGray)", onClick: onCancel, "data-testid": "no" }, { children: "Cancel" })), jsxRuntime.jsx(Button, __assign({ primary: true, "data-testid": "yes", onClick: onConfirm }, { children: "Continue" }))] }))] })) })) }))] }));
}

var css_248z$4 = ".RadioButtonGroup-module_item__yCRLQ {\n    display: flex;\n    flex-direction: row;\n    font-size: 1rem;\n    gap: 0.5em;\n    margin: 20px;\n    color: var(--color-mediumGray);\n}\n\n.RadioButtonGroup-module_icon__j3D3u {\n    color: var(--color-actionBlue);\n    background: radial-gradient(circle, var(--color-actionBlue) 40%, white 50% );\n    border-radius: 100%;\n}\n\n.RadioButtonGroup-module_option__InW5p {\n    color: var(--color-darkGray);\n}";
var styles$4 = {"item":"RadioButtonGroup-module_item__yCRLQ","icon":"RadioButtonGroup-module_icon__j3D3u","option":"RadioButtonGroup-module_option__InW5p"};
styleInject(css_248z$4);

var css_248z$3 = ".Typography-module_heading1__4gmU7 {\n  font-family: var(--common-font);\n  font-size: 32px;\n  color: var(--color-darkGray);\n}\n\n.Typography-module_heading2__D7Prd {\n    font-family: 'Roboto';\n    font-size: 18px;\n    line-height: 21.1px;\n}\n\n.Typography-module_title__PfswO {\n    font-family: 'Roboto';\n    font-size: 24px;\n    font-weight: bolder;\n    line-height: 28.1px;\n    letter-spacing: 0pt;\n    color: #666666;\n}\n\n.Typography-module_caption1__xaCJb {\n    font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;\n    font-size: 14px;\n    line-height: 16.4pt;\n    letter-spacing: 0pt;\n    color: var(--color-darkGray);\n}\n\n.Typography-module_caption2__gln43 {\n    font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;\n    font-size: 15px;\n    line-height: 17.6pt;\n    letter-spacing: 0pt;\n    color: #666666;\n}\n\n.Typography-module_menu__5i4H6 {\n    font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;\n    font-size: 24px;\n    font-weight: bolder;\n    line-height: 28.1pt;\n    letter-spacing: 0pt;\n    color: var(--color-darkGray);\n}\n\n.Typography-module_placeholder__6e4ro {\n    font-family: 'Roboto';\n    font-size: 14px;\n    line-height: 16.4px;\n    letter-spacing: 0pt;\n    color: #959595;\n}\n\n.Typography-module_subheading__a9d6v {\n    font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;\n    font-size: 17px;\n    font-weight: bolder;\n    line-height: 21.8px;\n    letter-spacing: 0px;\n    color: #333333;\n}\n\n.Typography-module_link__GnwHq {\n    font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;\n    font-size: 18px;\n    line-height: 21px;\n    letter-spacing: 0px;\n    color: #182D36;\n}\n\n.Typography-module_button__s-u-b {\n    font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;\n    font-size: 18px;\n    line-height: 21px;\n    letter-spacing: 0px;\n    color: #000000;\n}\n\n.Typography-module_label__-CGg4 {\n    display: block;\n    font-size: 1rem;   \n    color: var(--color-darkGray);\n}\n";
var styles$3 = {"heading1":"Typography-module_heading1__4gmU7","heading2":"Typography-module_heading2__D7Prd","title":"Typography-module_title__PfswO","caption1":"Typography-module_caption1__xaCJb","caption2":"Typography-module_caption2__gln43","menu":"Typography-module_menu__5i4H6","placeholder":"Typography-module_placeholder__6e4ro","subheading":"Typography-module_subheading__a9d6v","link":"Typography-module_link__GnwHq","button":"Typography-module_button__s-u-b","label":"Typography-module_label__-CGg4"};
...
var Link = function (_a) {
    var children = _a.children, overrideColor = _a.overrideColor, overrideFont = _a.overrideFont, link = _a.link;
    return (jsxRuntime.jsx("a", __assign({ href: link, style: { color: overrideColor, fontFamily: overrideFont }, className: classNames$1(styles$3.link) }, { children: children })));
};
...
var Label = function (_a) {
    var children = _a.children, customStyles = _a.customStyles;
    return (jsxRuntime.jsx("label", __assign({ style: customStyles, className: classNames$1(styles$3.label) }, { children: children })));
};

var RadioButtonGroup = function (_a) {
    var data = _a.data, label = _a.label, isSelected = _a.isSelected, onChange = _a.onChange;
    return (jsxRuntime.jsx(et, __assign({ value: isSelected, onChange: onChange }, { children: jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [label && jsxRuntime.jsx(et.Label, { children: jsxRuntime.jsx(Label, { children: label }) }), data.map(function (element) { return (
                ...
                jsxRuntime.jsx(et.Option, __assign({ value: element.id, as: React.Fragment }, { children: function (_a) {
                        ...
                        return (jsxRuntime.jsxs("div", __assign({ className: classNames$1(styles$4.item) }, { children: [jsxRuntime.jsx("span", __assign({ className: checked ? classNames$1(styles$4.icon) : "" }, { children: jsxRuntime.jsx(Circle$1, {}) })), jsxRuntime.jsx("span", __assign({ className: classNames$1(styles$4.option) }, { children: element.value }))] })));
                    } }), element.id)); })] }) })));
};
...
var styles$2 = {"formElement":"FormElement-module_formElement__KEdBL"};
styleInject(css_248z$2);

function FormElement(_a) {
    var label = _a.label, children = _a.children;
    return (jsxRuntime.jsxs("div", __assign({ "data-testid": "form-element", className: classNames$1(styles$2.formElement) }, { children: [label && (jsxRuntime.jsx(Label, __assign({ customStyles: { paddingBottom: "0.6250em" } }, { children: label }))), children] })));
}

var Dropdown = function (_a) {
    var label = _a.label, onChange = _a.onChange, selected = _a.selected, options = _a.options;
    return (jsxRuntime.jsx("div", __assign({ "data-testid": "div", className: "text-left pb-5" }, { children: jsxRuntime.jsx(FormElement, __assign({ label: label }, { children: jsxRuntime.jsx(pt, __assign({ as: "div", className: "space-y-1 min-w-fit", value: selected, onChange: onChange, "data-testid": "listbox" }, { children: jsxRuntime.jsxs("div", __assign({ "data-testid": "buttonAndOptions", className: "relative min-w-fit " }, { children: [jsxRuntime.jsx("span", __assign({ className: "inline-block min-w-fit w-full rounded-md shadow-sm" }, { children: jsxRuntime.jsxs(pt.Button, __assign({ "data-testid": "button", className: " flex bg-white shadow appearance-none border rounded w-full text-gray-700 leading-tight cursor-default relative w-full py-2 px-3 text-left focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition ease-in-out duration-150 sm:leading-5" }, { children: [jsxRuntime.jsx("span", __assign({ className: "mr-[25px] block truncate" }, { children: selected ? selected : "Select..." })), jsxRuntime.jsx("span", __assign({ className: "pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2" }, { children: jsxRuntime.jsx(ChevronDown$1, { children: "className=\"h-5 w-5 text-gray-400\" aria-hidden=\"true\"" }) }))] })) })), jsxRuntime.jsx(pt.Options, __assign({ className: "absolute mt-1 min-w-fit max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm" }, { children: options.map(function (option, index) { return (jsxRuntime.jsx(pt.Option, __assign({ "data-testid": index, className: function (_a) {
                                    var active = _a.active;
                                    return "relative cursor-default select-none py-2 pl-10 pr-4 ".concat(active ? "bg-amber-100 text-amber-900" : "text-gray-900");
                                }, value: option.value }, { children: function (_a) {
                                    var selected = _a.selected;
                                    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("span", __assign({ className: "block truncate ".concat(selected ? "font-medium" : "font-normal") }, { children: option.label ? option.label : option.value })), selected ? (jsxRuntime.jsx("span", __assign({ className: "absolute inset-y-0 left-0 flex items-center pl-3 text-amber-600" }, { children: jsxRuntime.jsx(Check$1, { children: " className=\"h-5 w-5\" aria-hidden=\"true\"" }) }))) : null] }));
                                } }), index)); }) }))] })) })) })) })));
};

var Input = function (_a) {
    var placeholder = _a.placeholder; _a.label; var type = _a.type, onChange = _a.onChange, value = _a.value;
    return (jsxRuntime.jsx("input", { value: value, type: type, className: 'shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline', onChange: function (e) { return onChange(e.target.value); }, placeholder: placeholder, defaultValue: value, "data-testid": "input-box" }));
};
...
var Accordion = function (_a) {
    ...
    return (jsxRuntime.jsx("div", __assign({ className: "w-full px-4 pt-16" }, { children: jsxRuntime.jsx("div", __assign({ className: "mx-auto w-full rounded-2xl p-2" }, { children: data.map(function (data, index) { return (jsxRuntime.jsx(Oe$3, { children: function (_a) {
                    var open = _a.open;
                    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs(Oe$3.Button, __assign({ className: "flex w-full mb-2 justify-between rounded-lg bg-stone-200 px-4 py-2 text-left text-sm font-medium text-stone-900 hover:bg-stone-300 focus:outline-none focus-visible:ring focus-visible:ring-stone-500 focus-visible:ring-opacity-75" }, { children: [jsxRuntime.jsx(Label, { children: data.title }), jsxRuntime.jsx(ChevronUp$1, { className: "".concat(open ? "rotate-180 transform" : "", " h-5 w-5 text-stone-900") })] })), jsxRuntime.jsx(Oe$3.Panel, __assign({ className: "px-4 pt-4 pb-2 text-sm text-gray-600" }, { children: data.content }))] }));
                } }, index)); }) })) })));
};
...
var DatePicker = function (_a) {
    ...
    return (jsxRuntime.jsx("input", { type: "date", "data-testid": "DRP", value: dateValue, className: classNames$1(styles.input), onChange: function (e) { return onChange(e.target.value); } }));
};
...
var Tabs = function (_a) {
    var data = _a.data;
    return (jsxRuntime.jsx("div", __assign({ className: " w-full px-2 py-16 sm:px-0" }, { children: jsxRuntime.jsxs(qe.Group, { children: [jsxRuntime.jsx(qe.List, __assign({ className: "flex " }, { children: data.map(function (data, index) { return (jsxRuntime.jsx(qe, __assign({ className: function (_a) {
                            var selected = _a.selected;
                            return classNames(" w-full py-2.5 text-md leading-5 focus-visible:outline-none", selected
                        ...
                        } }, { children: data.title }), index)); }) })), jsxRuntime.jsx(qe.Panels, __assign({ className: "mt-2" }, { children: data.map(function (data, index) { return (jsxRuntime.jsx(qe.Panel, __assign({ className: classNames("rounded-xl p-3 ") }, { children: data.content }), index)); }) }))] }) })));
};
...
function Home() {
    ...
    return (jsxRuntime.jsx("div", __assign({ className: "grid h-screen place-items-center" }, { children: jsxRuntime.jsx(DatePicker, { onChange: null }) })));
}
