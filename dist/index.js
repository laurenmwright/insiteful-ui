...
var Accordion = function (_a) {
    ...
    return (jsxRuntime.jsx("div", __assign({ className: "w-full px-4 pt-16" }, { children: jsxRuntime.jsx("div", __assign({ className: "mx-auto w-full max-w-md rounded-2xl bg-white p-2" }, { children: data.map(function (data) { return (jsxRuntime.jsx(Oe$3, { children: function (_a) {
                    var open = _a.open;
                    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs(Oe$3.Button, __assign({ className: "flex w-full justify-between rounded-lg bg-lightGray px-4 py-2 text-left text-sm font-medium text-darkGray hover:bg-red-900 focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75" }, { children: [jsxRuntime.jsx("span", { children: data.title }), jsxRuntime.jsx(ChevronUp$1, { className: "".concat(open ? "rotate-180 transform" : "", " h-5 w-5 text-purple-500") })] })), jsxRuntime.jsx(Oe$3.Panel, __assign({ className: "px-4 pt-4 pb-2 text-sm text-gray-500" }, { children: data.content }))] }));
                } })); }) })) })));
};
...
function Home() {
    ...
    return (jsxRuntime.jsx("div", __assign({ className: "grid h-screen place-items-center" }, { children: jsxRuntime.jsx(Accordion, { data: data }) })));
}
