...
var Button = function (_a) {
    ...
    return (jsxRuntime.jsx("button", __assign({ type: type ? type : "button", onClick: onClick, disabled: disabled, style: { backgroundColor: overrideColor }, className: classNames$1(styles$5.button, (_b = {}, _b[styles$5.primary] = primary, _b), (_c = {}, _c[styles$5.editor] = editor, _c), (_d = {}, _d[styles$5.secondary] = secondary, _d), (_e = {}, _e[styles$5.outline] = outline, _e)) + " ".concat(twClasses ? twClasses : "") }, { children: children })));
};
...
var css_248z$3 = ".FormElement-module_formElement__KEdBL {\n    display: flex; \n    margin-bottom: 1.5rem; \n    margin-top: 1rem; \n    flex-direction: column; \n    width: 10rem; \n}\n\n.FormElement-module_label__jkKt0 {\n    padding-bottom: 10px;\n}";
...
var Modal = function (_a) {
    ...
    return (jsxRuntime.jsx("div", __assign({ className: classNames$1(styles$1.dialogBox) }, { children: jsxRuntime.jsx(gt, __assign({ "data-testid": "dialog", as: "div", className: "relative z-10", open: isOpen, onClose: onClose }, { children: jsxRuntime.jsx("div", __assign({ className: "fixed inset-0 overflow-y-auto flex min-h-full items-center justify-center p-4 text-center" }, { children: jsxRuntime.jsxs(gt.Panel, __assign({ "data-testid": "panel", className: classNames$1(styles$1.dialogBox) }, { children: [jsxRuntime.jsx("span", __assign({ className: classNames$1(styles$1.button) }, { children: jsxRuntime.jsx("button", __assign({ "data-testid": "icon", onClick: onClose }, { children: jsxRuntime.jsx(X$1, { color: 'red', size: 18 }) })) })), title && (jsxRuntime.jsx("span", __assign({ className: classNames$1(styles$1.header) }, { children: jsxRuntime.jsx(gt.Title, __assign({ "data-testid": "title" }, { children: jsxRuntime.jsx(Heading1, { children: title }) })) }))), jsxRuntime.jsx("div", __assign({ className: classNames$1(styles$1.modalChildren) }, { children: children }))] })) })) })) })));
};

var css_248z$1 = ".DatePicker-module_input__pcSW8 {\n    padding-top: 0.5rem;\n    padding-bottom: 0.5rem; \n    padding-left: 0.75rem;\n    padding-right: 0.75rem; \n    color: #374151; \n    line-height: 1.25; \n    width: 1.5rem; \n    border-radius: 0.25rem; \n    border-width: 1px; \n    appearance: none; \n    box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06); \n}";
...
var Tabs = function (_a) {
    var data = _a.data;
    return (jsxRuntime.jsx("div", __assign({ className: "w-full max-w-md px-2 py-16 sm:px-0" }, { children: jsxRuntime.jsxs(We$1.Group, { children: [jsxRuntime.jsx(We$1.List, __assign({ className: "flex space-x-1 rounded-xl bg-blue-900/20 p-1" }, { children: data.map(function (data) { return (jsxRuntime.jsx(We$1, __assign({ className: function (_a) {
                            var selected = _a.selected;
                        ...
                        } }, { children: data.title }))); }) })), jsxRuntime.jsx(We$1.Panels, __assign({ className: "mt-2" }, { children: data.map(function (data) { return (jsxRuntime.jsx(We$1.Panel, __assign({ className: classNames("rounded-xl bg-white p-3", "ring-white ring-opacity-60 ring-offset-2 ring-offset-blue-400 focus:outline-none focus:ring-2") }, { children: data.content }))); }) }))] }) })));
};
...
function Home() {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: "bg-red-300 grid h-screen place-items-center" }, { children: [jsxRuntime.jsx(Accordion, { data: data }), jsxRuntime.jsx(Button, __assign({ primary: true }, { children: "text" }))] })));
}
